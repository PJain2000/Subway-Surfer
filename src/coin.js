...
let coin = class {
    constructor(gl, pos) {
        ...
        for (var i = 0; i < n; i++)
        {
            ...
            this.positions.push(Math.cos(i*theta) * 0.3);
            this.positions.push(Math.sin(i*theta) * 0.3);
            this.positions.push(0.0);

            this.positions.push(Math.cos((i+1)*theta) * 0.3);
            this.positions.push(Math.sin((i+1)*theta) * 0.3);
            this.positions.push(0.0);
        };
